...
<p>名稱:<input type="text" name="vgeid" size="30" value=" ${forum.vgeid}" maxlength="30"></p>
<p>標題:<input type="text" name="vgename" size="30" value=" ${forum.vgename}" maxlength="30"></p>
<p>發表:<input type="text" name="vgetheme" size="30" value=" ${forum.vgetheme}" maxlength="30"></p>
<p>文章:<textarea name="vgecontent" rows="6" cols="30">${forum.vgecontent}</textarea></p>
